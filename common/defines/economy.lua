NDefines.NEconomy.ADVISOR_COST = 0
...
NDefines.NEconomy.DEBASE_ADDED_CORRUPTION = 5
NDefines.NEconomy.DEBASE_MAX_CORRUPTION = 100
NDefines.NEconomy.DEBASE_MAX_STORED_MONTHS = 12
